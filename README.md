...
7. The sweet's show page should include the sweet's name. DONE
...
8. Make each vendor in the list of vendors on the sweet page link to its respective vendor  DONE

9. Make each sweet in the list of sweets on the vendor page link to its respective sweet  DONE

10. Create a validation that prevents a `VendorSweet` from being saved if one already exists for that `Vendor` and `Sweet`. Make sure the message shown to your users makes enough sense for them to fix the error. DONE
